...
class InventoryControllerTest {
    ...
    public void addProductToInventoryTest() throws Exception{
        ...
        when(inventoryService.addProductToInventory(request.getUserId(),request.getProductId(),request.getQuantity())).thenReturn(inventoryDb);
    ...
    public void transferProductTest() throws Exception{
        ...
        InventoryMovement inventoryMovement = new InventoryMovement(4,originUser,destinyUser,productTest,quantityTransferred,date, time );

        when(inventoryMovementsService.transferProduct(originUserId,destinyUserId,productId,quantityTransferred)).thenReturn(inventoryMovement);
