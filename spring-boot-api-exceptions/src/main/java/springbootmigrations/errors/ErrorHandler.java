package springbootmigrations.errors;
...
import springbootmigrations.exceptions.NotFoundException;
...
public class ErrorHandler  extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleCustomerNotFoundException(NotFoundException ex, WebRequest webRequest){
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setTimestamp( LocalDateTime.now());
